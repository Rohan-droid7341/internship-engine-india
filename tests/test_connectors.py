    ...
    payload = [
        {
            ...
            "url": "https://ats.rippling.com/x/jobs/u1",
        }
    ]
...
def test_workable():
    payload = {
        "results": [
            {
                "title": "AI Inference Engineer Intern",
                "shortcode": "ABC123",
    ...
    payload = [
        {
            "id": "fa06",
            "name": "SWE Intern",
            "url": "https://acme.breezy.hr/p/fa06-swe",
            "published_date": "2026-06-15T16:41:15.395Z",
            "location": {"name": "Provo, UT"},
            "salary": "$25/hr",
        }
    ]
        ...
        "offers": [
            {
                ...
                "description": "<p>No visa sponsorship.</p>",
            }
        ]
    }
